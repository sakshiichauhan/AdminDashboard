...
import type { User as DashboardUser } from "@/components/application-component/dashboard-page";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
                    ...
                    <div className="rounded-md border p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-500">
                            Sent via WhatsApp on May 12, 2023
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div className="rounded-md border p-4">
                      <div className="mb-2 flex items-center justify-between">
                        ...
                        <p className="text-xs text-gray-500">
                          Added by Admin on May 17, 2023
                        </p>
                      </div>
                      <p className="text-sm text-gray-700">
                        Student showed interest in engineering programs. Needs
                        detailed guidance on entrance exam preparation.
                      </p>
                    </div>
                    ...
                    <div className="rounded-md border p-4">
                      <div className="mb-2 flex items-center justify-between">
                        ...
                        <p className="text-xs text-gray-500">
                          Added by Admin on May 15, 2023
                        </p>
                      </div>
                      <p className="text-sm text-gray-700">
                        Parents requested a joint session to discuss career
                        options. Schedule for next week.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="rounded-md border border-yellow-200 bg-yellow-50 p-4">
                    <div className="mb-2 flex items-center justify-between">
                      ...
                      <p className="text-xs text-yellow-800">
                        Flagged on May 12, 2023
                      </p>
                    </div>
                    <p className="text-sm text-yellow-800">
                      Student has missed 2 sessions in the last month. Requires
                      follow-up to understand reasons.
                    </p>
                  </div>
                </CardContent>
              </Card>
